        ...
        class DopeSheetRenderer
        {
            ...
            void DoVoidContextMenu(Event e) {
                ...
                if ( copyKeyframes != null && copyKeyframes.Length == allCurves.Length ) {
                    ...
                    menu.AddItem(new GUIContent("Paste Key At Scrub Time"), false, () => { PasteKeyAtTime(keyable.root.currentTime - keyable.startTime); });
                } else {
                    if ( multiCopyKeyframes != null && multiCopyKeyframes.Count != 0 && multiCopyKeyframes[0].Length == allCurves.Length ) {
                        ...
                        menu.AddItem(new GUIContent("Paste Keys At Scrub Time"), false, () => { PasteKeysSelected(keyable.root.currentTime - keyable.startTime, range, false); });
