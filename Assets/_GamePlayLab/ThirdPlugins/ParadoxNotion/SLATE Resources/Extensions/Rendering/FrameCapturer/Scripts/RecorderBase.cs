...
namespace Slate.UTJ.FrameCapturer
{
    ...
    public abstract class RecorderBase : MonoBehaviour
    {
        ...
        [SerializeField] protected MovieEncoderConfigs m_videoEncoderConfigs = new MovieEncoderConfigs(MovieEncoder.Type.PNG);
        [SerializeField] protected DataPath m_outputDir = new DataPath(DataPath.Root.Current, "Capture");
        [SerializeField] protected bool m_captureAudio = true;
        ...
        [SerializeField] protected CaptureControl m_captureControl = CaptureControl.Manual;
        ...
        {
            get {return m_videoEncoderConfigs;}
            set {m_videoEncoderConfigs = value;}
        }
