...
namespace Slate.UTJ.FrameCapturer
{
    ...
    public class MovieRecorder : RecorderBase
    {
        ...
        public bool supportVideo { get { return m_videoEncoderConfigs.supportVideo; } }
        public bool supportAudio { get { return m_videoEncoderConfigs.supportAudio; } }
        ...
        public override bool BeginRecording()
        {
            ...
            // create scratch buffer
            {
                ...
                if (m_videoEncoderConfigs.format == MovieEncoder.Type.MP4 ||
                    m_videoEncoderConfigs.format == MovieEncoder.Type.WebM)
                {
            ...
            // initialize encoder
            {
                ...
                string outPath = m_outputDir.GetFullPath() + "/" + m_outputDir.GetFileName();

                m_videoEncoderConfigs.captureVideo = m_captureVideo;
                m_videoEncoderConfigs.captureAudio = m_captureAudio;
                m_videoEncoderConfigs.Setup(m_scratchBuffer.width, m_scratchBuffer.height, 3, targetFramerate);
                m_encoder = MovieEncoder.Create(m_videoEncoderConfigs, outPath);
